...
import com.huawei.estravo.util.Constant;
...
public class Translations extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String API_KEY = "DAEDAGPHK86CxWXYJwqgUYqFiIyxIMV1LM+B+o5DAKguD7QppVMIt3ptBFQg2I/sYlkf6Ld0oarnJwN8K/e7Jh8NrXOpJl/71rkfCA==";
    ...
    private void createSpinner() {
        if (this.isEngLanguage()) {
            this.spSourceAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, Translations.SP_SOURCE_LIST_EN);
            this.spDestAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, Translations.SP_DEST_LIST_EN);
        } else {
            this.spSourceAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, Translations.SP_SOURCE_LIST);
            this.spDestAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, Translations.SP_DEST_LIST);
        }
        ...
        if (spSourceType != null) {
            this.spSourceType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    Translations.this.srcLanguage = Translations.SOURCE_LANGUAGE_CODE[position];
                    Log.i(Translations.TAG, "srcLanguage: " + Translations.this.srcLanguage);
                }
        ...
        if (spDestType != null) {
            this.spDestType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                @Override
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    Translations.this.dstLanguage = Translations.DEST_LANGUAGE_CODE[position];
                    Log.i(Translations.TAG, "dstLanguage: " + Translations.this.dstLanguage);
                }
    ...
    public boolean isEngLanguage() {
        ...
        if (locale != null) {
            ...
            return strLan != null && Translations.EN.equals(strLan);
        }
        return false;
    }
    ...
    private void updateDestLanguage(String code) {
        if (code.equalsIgnoreCase(Translations.SOURCE_LANGUAGE_CODE[0]) || code.equalsIgnoreCase(Translations.SP_SOURCE_LIST.get(0))) {
            this.dstLanguage = Translations.DEST_LANGUAGE_CODE[0];
            return;
        }
        if (this.spDestType == null) {
            return;
    ...
    private String getLanguageName(String code) {
        int index = 0;
        for (int i = 0; i < Translations.SOURCE_LANGUAGE_CODE.length; i++) {
            if (code.equalsIgnoreCase(Translations.SOURCE_LANGUAGE_CODE[i])) {
                index = i;
                break;
            }
        }
    ...
    private void translatePhoto() {
        Intent intent = new Intent(Translations.this, RemoteTranslateActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonSwitchLang:
                Translations.this.doLanguageSwitch();
                break;
            case R.id.select_photo:
                Translations.this.translatePhoto();
                break;
            default:
                break;
        }
